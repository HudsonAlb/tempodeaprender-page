...
const CONTACT_INFO = [
  {
    ...
    Icon: IconPhone,
    label: 'WhatsApp',
    value: 'whats.link/escolatempodeaprender',
  ...
  },
  {
    ...
    Icon: IconPin,
    label: 'Endereço',
    value: 'Avenida Paulo Leite, Nº 485 — Escada, Pernambuco',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 grid lg:grid-cols-2 gap-16">
        ...
        <div>
          ...
          <div className="mt-10 p-5 rounded-2xl bg-brand-sky-pale border-2 border-brand-sky-light">
            <p className="font-display font-bold text-brand-navy text-sm mb-2">
            ...
            >
              <Field id="nome" label="Nome completo" required>
                <input
                  ...
                  autoComplete="name"
                  required
                  className="tap-target w-full px-4 rounded-xl border-2 border-brand-sky-light text-sm text-brand-dark placeholder:text-brand-gray-mid focus:outline-none focus:border-brand-sky focus:ring-2 focus:ring-brand-sky/20 transition"
              ...
              <Field id="serie" label="Segmento de interesse" required>
                <select
                  ...
                  required
                  defaultValue=""
                  className="tap-target w-full px-4 rounded-xl border-2 border-brand-sky-light text-sm text-brand-dark focus:outline-none focus:border-brand-sky focus:ring-2 focus:ring-brand-sky/20 transition bg-white"
                  aria-required="true"
                >
